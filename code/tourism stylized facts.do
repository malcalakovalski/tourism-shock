...
replace ca_dif_20=ca_20-ca_1519
...
eststo clear
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0, robust
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0 & ifs_code~=443, robust
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0 & ae==1 & ifs_code~=443, robust
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0 & ae==0 & ifs_code~=443, robust
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0 & ifs_code~=443 & btv_1519>0, robust
eststo: reg ca_dif_20 ca_1519 boil_1519 btv_1519 if sample==0 & ifs_code~=443 & btv_1519<0, robust


esttab using ca.csv, replace r2 label b(a2) title (CA regressions) ///
...
esttab using growth1.csv, replace r2 label b(a2) title (growth regressions) ///
mtitles("All" "All" "All" "All" "AE" "EM") starlevels( * 0.10 ** 0.05 *** 0.010)
...
eststo: reg grow_dif cases1000 deaths1000 stringency tour_dir lgdppc lpop agr_1419 manuf_1419 if sample==0 & gdpd_19>100, robust
eststo: reg grow_dif cases1000 deaths1000 stringency tour_dir lgdppc lpop agr_1419 manuf_1419 if sample==0 & gdpd_19<100, robust
...
eststo: reg grow_dif cases1000 deaths1000 stringency tour_dir lgdppc lpop agr_1419 manuf_1419 if sample==0 & tour_dir<5, robust
eststo: reg grow_dif cases1000 deaths1000 stringency tour_dir lgdppc lpop agr_1419 manuf_1419 bpas_1519 if sample==0, robust
eststo: reg grow_dif cases1000 deaths1000 stringency tour_dir lgdppc lpop agr_1419 manuf_1419 bpas_1519 if sample==0 & ae==0, robust
eststo: reg grow_dif cases1000 deaths1000 stringency btv_1519 lgdppc lpop agr_1419 manuf_1419 if sample==0, robust


esttab using growth2.csv, replace r2 label b(a2) title (growth regressions) ///
mtitles("All" "All" "All" "All" "All" "All" "All" "EM") starlevels( * 0.10 ** 0.05 *** 0.010)
